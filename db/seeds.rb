...
bird.answers.create(question: monster_q, content: "Happens to the best of us, lord knows I've had my fair share of court-mandated rehab visits. I'd recommend the 'Sundown Rehab Salon'.")
...
monster.answers.create(question: bird_q, content: "Ah shoot, just sold mine :/")
...
monster.answers.create(question: ernie_q, content: "Die")
